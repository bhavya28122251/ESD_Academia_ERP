package org.esdpracticals.academicerp.academicerp.repo;
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("SELECT new org.esdpracticals.academicerp.academicerp.dto.FacultyCourseScheduleResponse(cs, s.name) " +
            "FROM " +
